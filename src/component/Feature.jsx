...
const Feature = () => {
    return (
        <div className="grid grid-cols-2 container m-auto w-full items-center relative justify-center mt-40">
            <div className="w-full grid justify-center items-center">
                ...
                <div className="flex justify-center flex-col items-center mt-10 w-150 m-auto p-4 rounded-2xl bg-[#00338562] h-fit">
                    ...
                    <p className={`w-[80%] text-center  text-[#ffffff] text-xl ${poppins.className} `}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam autem distinctio a impedit vero nihil magni neque quia quisquam tenetur, quos ipsum dolorum minus facere consequatur non eveniet dicta dolor.</p>
                    <br />
